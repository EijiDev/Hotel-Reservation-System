...
<section class="rooms">
    ...
    <div class="room-grid">
        ...
        <!-- Room 2 -->
        <div class="room-card">
            <img src="./assets/room2.png" alt="Spacious Triple Bed Room">
            <div class="card-content">
                <div class="card-header">
                    <h2>Cozy Single Bed Room</h2>
        ...
        <!-- Room 3 -->
        <div class="room-card">
            <img src="./assets/room4.png" alt="Cozy Single Bed Room">
            <div class="card-content">
                <div class="card-header">
                    <h2>Spacious Triple Bed Room</h2>
        ...
        <!-- Room 4 -->
        <div class="room-card">
            <img src="./assets/room3.png" alt="Cozy Single Bed Room">
            <div class="card-content">
                <div class="card-header">
                    <h2>City View Twin Bed Room</h2>
                    <span class="rating">4.7</span>
                </div>
        ...
        <!-- Room 5 -->
        <div class="room-card">
            <img src="./assets/room5.png" alt="Cozy Single Bed Room">
            <div class="card-content">
                <div class="card-header">
                    <h2>Zen Garden Room</h2>
                    <span class="rating">4.9</span>
                </div>
        ...
        <!-- Room 6 -->
        <div class="room-card">
            <img src="./assets/room6.png" alt="Cozy Single Bed Room">
            <div class="card-content">
                <div class="card-header">
                    <h2>Celestial Suite</h2>
